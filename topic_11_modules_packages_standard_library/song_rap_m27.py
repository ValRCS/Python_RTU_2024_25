...
if __name__ == "__main__":
    # dziesma = Song("Īssavienojums","Prāta Vētra", ("Cik dīvainas ir tās paralēles", "Kas ved mūs pa takām kalnā", "Un kad tu mani trīsreiz piekrāpsi", "Es pazudīšu ar salnām", "Tad stāvēšu dzelzce
